...
\subsection{Path Planning in Functionally Graded Materials} \label{ssec:functionallygraded}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.38\textwidth]{Spaces.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.475\textwidth]{PathPlanning_1.png}
    \vspace{-6pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.475\textwidth]{PathPlanning_2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.135\textwidth]{1A.png}
    \hfill
    \includegraphics[width=0.16\textwidth]{1C.png}
    \hfill
    \includegraphics[width=0.16\textwidth]{1B.png}
...
\section{Simplex Grid} \label{sec:simplexgrid}
...
\begin{figure}[h]
    \centering
    \hfill
    \includegraphics[width=0.135\textwidth]{2A.png}
    \hfill
    \includegraphics[width=0.16\textwidth]{2B.png}
    \hfill
...
The number of points can be found by, again, considering the surrogate problem of ball compositions mentioned in Section~\ref{ssec:combinatorialcomplexities} and noting that if the last ball cannot be removed from any position, there will be $d$ fewer possible options to perform $d-1$ moves, thus resulting in $N_I$ samples:
\begin{equation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{SimplexGraphBinary.png}
...
\subsection{Ternary} \label{ssec:ternarygraph}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{SimplexGraphTernaryBlue.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.475\textwidth]{SimplexGraphQuaternaryAnnotated.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{GraphComplexMap1.png}
    \includegraphics[width=0.45\textwidth]{GraphComplex1Trim.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{GraphComplexMap2.png}
    \includegraphics[width=0.47\textwidth]{GraphComplex2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{GraphComplexMap3.png}
    \includegraphics[width=0.47\textwidth]{GraphComplex3.png}
