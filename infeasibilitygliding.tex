...
One core assumption that needs to be considered in exploration based on the infeasibility gliding is that the bounding the infeasible space is surface is smooth. 
